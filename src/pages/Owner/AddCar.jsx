    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex flex-col w-full'>
            <label> Location </label>
                <select onChange={e=> setCar({...car, location: e.target.value})} value={car.location} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
                    ...
                    <option value="oyinbo">oyinbo</option>
                    <option value="Festac">Festac</option>
                    <option value="Mazamaza">Mazamaza</option>
        ...
        <div className='flex flex-col w-full'>
                ...
                <textarea  rows={5} placeholder="e.g. A luxurious SUV with a spacious interior ans a powerful engine." required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=> setCar({...car, description: e.target.value})}></textarea>
            </div>

            <button className='flex item-center gap-2 px-4 py-2.5 mt-4 bg-primary text-white rounded-md font-medium w-max cursor-pointer'>
